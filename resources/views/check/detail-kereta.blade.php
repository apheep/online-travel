  ...
  <div id="modal-terima" class="fixed inset-0 z-50 hidden">
    ...
    <div class="space-y-6">
      ...
      <section class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
          <div>
            <p class="text-gray-500">Operator / Kereta</p>
            <p class="font-semibold text-gray-900">KAI • Argo Parahyangan</p>
          </div>
          <div>
            <p class="text-gray-500">Kode Booking</p>
            <p class="font-semibold text-gray-900">KR12345</p>
          </div>
          <div>
            <p class="text-gray-500">Berangkat</p>
            <p class="font-semibold text-gray-900">GMR → BD, 15 Jan 2024, 07:30</p>
          </div>
          <div>
            <p class="text-gray-500">Tiba</p>
            <p class="font-semibold text-gray-900">BD, 15 Jan 2024, 11:00</p>
          </div>
          <div>
