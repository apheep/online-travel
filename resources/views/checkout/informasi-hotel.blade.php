        ...
        <div class="max-w-6xl mx-auto px-4 py-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 mb-6 rounded-2xl overflow-hidden">
                ...
                <div class="lg:col-span-2">
                    <img src="{{ asset('icons/pemandangan5.png') }}" 
                        alt="Hotel Utama" 
                        class="w-full h-[400px] object-cover">
                </div>

                <!-- Side Images -->
                <div class="grid grid-rows-2 h-[400px]">
                    <!-- Row 1 -->
                    <div class="grid grid-cols-2">
                        <img src="{{ asset('icons/pemandangan1.png') }}" 
                            alt="Kamar Hotel" 
                            class="w-full h-full object-cover">
                        <img src="{{ asset('icons/pemandangan2.png') }}" 
                            alt="Kamar Hotel" 
                            class="w-full h-full object-cover">
                    </div>
                    <!-- Row 2 -->
                    <div class="grid grid-cols-2">
                        <img src="{{ asset('icons/pemandangan3.png') }}" 
                            alt="Kolam Renang" 
                            class="w-full h-full object-cover">
                        <img src="{{ asset('icons/pemandangan4.png') }}" 
                            alt="Pemandangan" 
                            class="w-full h-full object-cover">
                    </div>
                </div>
            ...
            <!-- Hotel Description -->
            <div class="mb-6">
                <h3 class="text-lg font-semibold text-gray-800 mb-2">Tentang hotel majapahit surabaya</h3>
                <p class="text-gray-600 text-sm leading-relaxed mb-3">
                    <span class="font-medium">Lokasi Hotel</span>
                </p>
                ...
                <button class="bg-gradient-to-r from-[#187499] to-[#36AE7E] bg-clip-text text-transparent font-semibold text-sm mt-2 hover:underline">Lebih banyak </button>
            </div>
