        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-[#187499] to-[#36AE7E] rounded-2xl shadow-lg p-8 mb-6 text-white">
                <div class="text-center">
                    ...
                    <p class="text-green-100 text-lg">Hotel Anda telah berhasil dipesan</p>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
                <h2 class="text-xl font-bold text-gray-900 mb-4">Detail Hotel</h2>
                <div class="space-y-4">
                    <h3 class="text-lg font-bold text-gray-900">Hotel Majapahit Surabaya</h3>
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                        <div>
                            <span class="text-gray-600 font-medium">Kamar:</span>
                            <p class="text-gray-900">Kamar King</p>
                        </div>
                        <div>
                            <span class="text-gray-600 font-medium">Tamu:</span>
                            <p class="text-gray-900">3 Dewasa</p>
                        </div>
                        <div>
                            <span class="text-gray-600 font-medium">Kasur:</span>
                            <p class="text-gray-900">2 ranjang</p>
                        </div>
                        <div>
                            <span class="text-gray-600 font-medium">Fasilitas:</span>
                            <p class="text-gray-900">TV, Bathtub, Teras</p>
                        </div>
                        <div>
                            <span class="text-gray-600 font-medium">Sarapan:</span>
                            <span class="bg-teal-100 text-teal-700 px-2 py-1 rounded text-xs">Termasuk</span>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div class="p-3 bg-gray-50 rounded-lg text-gray-900">Jl. Sudirman No. 123, Jakarta Pusat</div>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1">Check-in</label>
                                <div class="p-3 bg-gray-50 rounded-lg text-gray-900">15 September 2025</div>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1">Check-out</label>
                                <div class="p-3 bg-gray-50 rounded-lg text-gray-900">17 September 2025</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="guest2Data" class="guest-data hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1">Alamat</label>
                                <div class="p-3 bg-gray-50 rounded-lg text-gray-900">Jl. Thamrin No. 456, Jakarta Pusat</div>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1">Check-in</label>
                                <div class="p-3 bg-gray-50 rounded-lg text-gray-900">15 September 2025</div>
                ...
                <div id="guest3Data" class="guest-data hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1">Alamat</label>
                                <div class="p-3 bg-gray-50 rounded-lg text-gray-900">Jl. Gatot Subroto No. 789, Jakarta Pusat</div>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1">Check-in</label>
                                <div class="p-3 bg-gray-50 rounded-lg text-gray-900">15 September 2025</div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-6">
                ...
                <div class="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Surat Dinas</h3>
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                            <svg class="w-12 h-12 text-gray-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
                            <p class="text-gray-600 font-medium mb-3">SuratDinas_Perjalanan.pdf</p>
                            <p class="text-sm text-gray-500 mb-3">Uploaded ✓</p>
                            <button onclick="window.open('/documents/SuratDinas_Perjalanan.pdf', '_blank')" class="px-4 py-2 text-white rounded-lg text-sm font-medium transition duration-200" style="background: linear-gradient(135deg, #187499 0%, #36AE7E 100%);">
                                View 
                            </button>
                        </div>
                    </div>
    ...
    <script>
        ...
        const guestData = [
            {
                ...
                checkin: "15 September 2025",
                checkout: "17 September 2025"
            },
            {
                name: "Jane Smith",
        ...
        function initializeGuests() {
            ...
            guestData.forEach((guest, index) => {
                ...
                button.textContent = `Tamu ${guestNumber}`;
