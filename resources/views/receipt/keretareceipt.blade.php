        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-lg border-2 border-gray-100 p-8 mb-6 relative overflow-hidden">
                ...
                <div class="text-center relative z-10">
                    ...
                    <h1 class="text-4xl font-bold mb-3 text-gray-800">Pemesanan Kereta Berhasil!</h1>
                    <p class="text-gray-600 text-lg mb-6">Tiket kereta Anda telah berhasil dipesan</p>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
                <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8 mb-8">
                    ...
                    <div class="flex-1">
                        <div class="mb-6">
                            <h2 class="text-2xl font-semibold text-gray-900 mb-1">Detail Kereta</h2>
                            <p class="text-gray-500">KA Argo Bromo Anggrek</p>
                        </div>
                        
                        <!-- Train Info -->
                        <div class="mb-6">
                            <p class="text-sm font-medium text-gray-700 mb-3">Informasi Perjalanan</p>
                            <div class="flex flex-wrap gap-2">
                                <span class="inline-flex items-center px-3 py-1.5 rounded-md bg-gray-50 text-gray-700 text-sm font-medium border border-gray-200">
                                    <svg class="w-4 h-4 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 6h3a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V8a2 2 0 012-2h3m4 0V4a2 2 0 00-2-2H9a2 2 0 00-2 2v2m4 0a2 2 0 00-2-2H9a2 2 0 00-2 2v0a2 2 0 002 2h2a2 2 0 002-2v0z"></path>
                                    </svg>
                                    Eksekutif
                                </span>
                                <span class="inline-flex items-center px-3 py-1.5 rounded-md bg-gray-50 text-gray-700 text-sm font-medium border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm text-gray-600">Gerbong</p>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900">6A, 6B, 6C</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm text-gray-600">Stasiun Asal</p>
                                <p class="font-semibold text-gray-900">Gambir (GMR)</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded-lg p-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900">Surabaya Pasarturi (SBI)</p>
                            </div>
                        </div>
                    </div>
