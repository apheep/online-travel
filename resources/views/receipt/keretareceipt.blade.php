        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-gradient-to-r from-[#FE0004] to-[#F6B101] rounded-2xl shadow-lg p-8 mb-6 text-white">
                <div class="text-center">
                    ...
                    <p class="text-yellow-100 text-lg">Tiket kereta Anda telah berhasil dipesan</p>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
                <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                    <div>
                        <h2 class="text-xl font-bold text-gray-900">Detail Kereta</h2>
                        <h3 class="text-lg font-semibold text-gray-800 mt-1">KA Argo Bromo Anggrek</h3>
                        <div class="mt-2 flex flex-wrap gap-2 text-xs">
                            <span class="inline-flex items-center px-2 py-1 rounded-full bg-gray-100 text-gray-700">Eksekutif</span>
                            <span class="inline-flex items-center px-2 py-1 rounded-full bg-gray-100 text-gray-700">Kursi 6A, 6B, 6C</span>
                        </div>
                    </div>
                    <div class="text-right">
                        ...
                        <div class="mt-2 flex items-center justify-end gap-2">
                            <span class="bg-yellow-100 text-yellow-700 px-2 py-1 rounded text-xs">Nomor KA: KA 1</span>
                        </div>
                    </div>
                </div>
                ...
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div class="bg-gray-50 rounded-lg p-3 flex items-center justify-between">
                        ...
                        <dd class="text-gray-900 font-medium">Eksekutif</dd>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-3 flex items-center justify-between">
                        <dt class="text-gray-600 text-sm">Gerbong</dt>
                        <dd class="text-gray-900 font-medium">3</dd>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-3 flex items-center justify-between">
                        <dt class="text-gray-600 text-sm">Kursi</dt>
                        <dd class="text-gray-900 font-medium">6A, 6B, 6C</dd>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-3 flex items-center justify-between">
                    ...
                    <div class="bg-gray-50 rounded-lg p-3 flex items-center justify-between">
                        <dt class="text-gray-600 text-sm">Stasiun Asal</dt>
                        <dd class="text-gray-900 font-medium">Gambir (GMR)</dd>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-3 flex items-center justify-between">
                        <dt class="text-gray-600 text-sm">Stasiun Tujuan</dt>
                        <dd class="text-gray-900 font-medium">Surabaya Pasarturi (SBI)</dd>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-3 flex items-center justify-between">
