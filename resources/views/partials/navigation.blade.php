<!-- NavBar -->
  ...
  <div class="flex items-center justify-between max-w-7xl mx-auto px-10 py-6">
    ...
    <!-- Mobile Sidebar -->
    <div id="mobile-sidebar" class="fixed top-0 right-0 h-full w-64 bg-[F4F7FE] shadow-2xl transform translate-x-full transition-transform duration-300 ease-in-out z-50 overflow-y-auto">
