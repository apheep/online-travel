            ...
            <div class="bg-white rounded-2xl shadow-xl max-w-sm w-full max-h-[85vh] flex flex-col transform scale-95 opacity-0 transition-all duration-500 ease-out" id="dateModalContent">
                ...
                <div class="sticky top-0 bg-white rounded-t-2xl border-b border-gray-100 p-4 z-10">
                    ...
                    <div>
                        <div class="flex space-x-2">
                            <button id="oneWayBtn" onclick="switchTripType('oneWay')" class="flex-1 py-2 px-3 text-center text-sm font-medium rounded-lg border border-gray-300 transition-all duration-300 ease-out transform hover:scale-105 active:scale-95 bg-[#FE0004] text-white">
                                Sekali jalan
                            </button>
                            <button id="roundTripBtn" onclick="switchTripType('roundTrip')" class="flex-1 py-2 px-3 text-center text-sm font-medium rounded-lg border border-gray-300 transition-all duration-300 ease-out transform hover:scale-105 active:scale-95 bg-[#FE0004] text-white">
                                Pulang pergi
                            </button>
                        </div>
                    </div>
                ...
                <div class="flex-1 overflow-y-auto p-4">
                    ...
                    <div class="flex justify-end">
                        <button onclick="saveDate()" class="px-4 py-2 text-white rounded-lg text-sm font-medium transition duration-200 shadow-md bg-[#FE0004] hover:shadow-lg hover:scale-105">
                            Simpan
                        </button>
                    </div>
                </div>
